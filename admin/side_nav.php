   ...
   <div id="sidebar-scrollbar">
      <nav class="iq-sidebar-menu">
         <ul id="iq-sidebar-toggle" class="iq-menu">
            ...
            <li class="iq-menu-title"><i class="ri-subtract-line"></i><span>Managements</span></li>
            <li><a href="userslist.php" class="iq-waves-effect" aria-expanded="false"><i class="ri-user-line"></i><span>Users</span></a></li>
            <li><a href="productslist.php" class="iq-waves-effect" aria-expanded="false"><i class="ri-chat-check-line"></i><span>Products</span></a></li>
                  ...
                  <div class="iq-card shadow-none m-0">
                     <div class="iq-card-body p-0 ">
                        ...
                        <div class="d-inline-block w-100 text-center p-3">
                           <a class="btn btn-primary dark-btn-primary" href="index.php" role="button">Sign out<i class="ri-login-box-line ml-2"></i></a>
                        </div>
                     </div>
                  </div>
               </div>
